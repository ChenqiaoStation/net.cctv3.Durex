package net.cctv3.durex.newarchitecture.screens;
...
import net.cctv3.durex.MainActivity;
import net.cctv3.durex.R;
import net.cctv3.durex.newarchitecture.cache.SharedPreferenceUtils;
